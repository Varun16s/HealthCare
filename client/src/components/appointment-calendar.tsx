...
export default function AppointmentCalendar() {
  ...
  return (
    <div className="p-8" data-testid="appointment-calendar">
          ...
          <div className="space-y-4">
            {appointments.map((appointment: Appointment) => (
              <Card key={appointment.id} className={`border-l-4 ${
                appointment.supportType === "anxiety" ? "border-l-primary-500 bg-primary-50" :
                appointment.supportType === "adhd" ? "border-l-secondary-500 bg-secondary-50" :
                "border-l-sage-500 bg-sage-50"
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-sage-600 capitalize">
                        {appointment.supportType} Support
                      </p>
                      <div className="flex items-center mt-2 space-x-4">
                        <span className="text-sm text-sage-600 flex items-center">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center text-sage-600">
              ...
              <p className="mb-2">Interactive calendar coming soon!</p>
              <p className="text-sm text-sage-500">
